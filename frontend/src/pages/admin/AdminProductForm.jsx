    ...
    if (isEdit) {
      ...
      (async () => {
        try {
          ...
          setErrorMsg(err.message || "Failed to load product data");
        } finally {
  ...
  return (
    <Box maxWidth={1000} mx="auto">
      <Stack direction="row" justifyContent="space-between" alignItems="center" mb={3} sx={{display:"flex",flexDirection:"column" ,justifyContent:"center", mb:3}}>
        <Button startIcon={<ArrowBackIcon />} onClick={() => navigate("/admin/productList")} color="inherit" disabled={submitting}>
      ...
      <Box sx={{ borderBottom: 1, borderColor: "divider", mb: 3 }}>
        <Tabs value={activeTab} onChange={(_, val) => setActiveTab(val)}>
          <Tab label="Edit Details" fontWeight={700} disabled={submitting} />
          <Tab label="Live Product Preview" fontWeight={700} disabled={submitting} />
        </Tabs>
      </Box>
              ...
              <Box component="form" onSubmit={handleSubmit}>
                ...
                <Stack direction="row" spacing={2}  sx={{ mt:4}}>
                  ...
                  <Button
                    ...
                    size="large"
                  >
                    {submitting ? (isEdit ? "Updating..." : "Saving...") : "Save & Publish"}
                  </Button>
                </Stack>
              </Box>
            </Paper>
